...
原创 远云 2025-11-20 20:03 浙江

*[图片]*

AgentScope Java v0.2 版本正式发布，一文速览核心特效。
...
今天，我们很高兴地宣布 **AgentScope Java v0.2 版本**正式发布了，具备了所有核心的 ReActAgent 的能力。

***第一性原则：透明度***

*Aliware*

AgentScope 的首要设计目标是**对开发者透明**。
...
```
`dependency>`
`    groupId>io.agentscopegroupId>`
`    artifactId>agentscope-coreartifactId>`
...
`            ImageBlock.builder().source(URLSource.builder().url("[https://example.com/image.jpg](https://example.com/image.jpg)").build()).build()`
`        ))`
`        .build()`
`).block();`
...
点击阅读原文，去给 AgentScope Star ⬇

[阅读原文](https://github.com/agentscope-ai/agentscope-java)

[跳转微信打开](https://wechat2rss.xlab.app/link-proxy/?k=4217a4f0&r=1&u=https%3A%2F%2Fmp.weixin.qq.com%2Fs%3F__biz%3DMzU4NzU0MDIzOQ%3D%3D%26mid%3D2247520182%26idx%3D1%26sn%3Da5a92dd1d74e8aee6b8451c119945150)
