...
HiClaw 并不和其他 xxClaw 对标，HiClaw 是一个 Agent 协作网络。
...
```
bash https://higress.ai/hiclaw/install.sh)
```
...
例如局域网 IP 是 192.168.1.100，则填写 [http://192.168.1.100:18080](http://192.168.1.100:18080)。
...
`# Worker（将  替换为实际容器名）`
`docker exec -it  ls .openclaw/agents/main/sessions/`
...
***可能是模型的上下文窗口大小配置不正确，导致窗口耗尽前没有及时压缩。请参考******如何切换 Manager 的模型[****2]******和******如何切换 Worker 的模型[****3]******进行正确配置。***
...
Manager 的工作目录是宿主机上的 ~/hiclaw-manager，里面的 openclaw.json 可以直接编辑。参照 OpenClaw 文档**[****4]**中各平台的配置格式进行配置。
...
- Mac、Window 或 Linux 环境。
- Docker Desktop、Docker Engine（Linux）或 Podman Desktop。
- 本地 PC 部署、本地盒子部署、云端部署。
- 本地访问、公网访问。
...
[1] Higress AI 快速开始 — 控制台配置

[https://higress.ai/docs/ai/quick-start#%E6%8E%A7%E5%88%B6%E5%8F%B0%E9%85%8D%E7%BD%AE](https://higress.ai/docs/ai/quick-start#%E6%8E%A7%E5%88%B6%E5%8F%B0%E9%85%8D%E7%BD%AE)

[2] ***如何切换 Manager 的模型***

[https://github.com/open-telemetry/opentelemetry-go-compile-instrumentation/releases/tag/v0.1.0](https://github.com/open-telemetry/opentelemetry-go-compile-instrumentation/releases/tag/v0.1.0)

[3] ***如何切换 Worker 的模型***

[https://github.com/alibaba/hiclaw/blob/main/docs/zh-cn/faq.md#%E5%A6%82%E4%BD%95%E5%88%87%E6%8D%A2-worker-%E7%9A%84%E6%A8%A1%E5%9E%8B](https://github.com/alibaba/hiclaw/blob/main/docs/zh-cn/faq.md#%E5%A6%82%E4%BD%95%E5%88%87%E6%8D%A2-worker-%E7%9A%84%E6%A8%A1%E5%9E%8B)
